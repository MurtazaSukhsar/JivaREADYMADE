...
const en = {
  ...
  "checkout.city": "City",
  "checkout.state": "Town or City / District / State",
  ...
  "err.state": "Enter your town, city, district, or state",
...
const hi: Dictionary = {
  ...
  "checkout.city": "शहर",
  "checkout.state": "कस्बा या शहर / जिला / राज्य",
  ...
  "err.state": "अपना कस्बा, शहर, जिला या राज्य भरें",
...
const gu: Dictionary = {
  ...
  "checkout.city": "શહેર",
  "checkout.state": "નગર અથવા શહેર / જિલ્લો / રાજ્ય",
  ...
  "err.state": "તમારું નગર, શહેર, જિલ્લો અથવા રાજ્ય ભરો",
