...
const en = {
  ...
  "checkout.cod.terms": "COD Bill (Cash on Delivery)",
  "checkout.cod.dueOnDelivery": "On Delivery",
  "checkout.cod.advanceNote": "Note: Cash on Delivery orders require a {advance} advance paid online via Cashfree to confirm the order. The remaining balance is paid on delivery.",
  "checkout.paymentMethod": "Payment Method",
  "checkout.method.online": "Pay Online",
  "checkout.method.onlineSub": "Card, UPI, netbanking or wallet — secured by Cashfree",
  "checkout.payOnline": "Pay Online",
  "checkout.openingPayment": "Opening payment…",
  ...
  "checkout.method.codSub": "Pay {advance} advance, rest on delivery",
  ...
  "confirm.cod.advanceNote": "The {advance} advance payment was successfully paid online via Cashfree. The remaining balance of {due} will be collected in cash on delivery.",
...
const hi: Dictionary = {
  ...
  "checkout.cod.terms": "सीओडी बिल (डिलीवरी पर नकद)",
  "checkout.cod.dueOnDelivery": "डिलीवरी पर",
  "checkout.cod.advanceNote": "ध्यान दें: कैश ऑन डिलीवरी ऑर्डर पक्का करने के लिए Cashfree के ज़रिए {advance} अग्रिम भुगतान ऑनलाइन करना होगा। शेष राशि का भुगतान डिलीवरी के समय लिया जाएगा।",
  "checkout.paymentMethod": "भुगतान विधि",
  "checkout.method.online": "ऑनलाइन भुगतान",
  "checkout.method.onlineSub": "कार्ड, UPI, नेटबैंकिंग या वॉलेट — Cashfree द्वारा सुरक्षित",
  "checkout.payOnline": "ऑनलाइन भुगतान करें",
  "checkout.openingPayment": "भुगतान खुल रहा है…",
  "checkout.method.upi": "UPI / GPay",
  "checkout.method.upiSub": "स्कैन या टैप करें — रकम अपने आप भर जाएगी",
  "checkout.method.cod": "कैश ऑन डिलीवरी",
  "checkout.method.codSub": "{advance} अग्रिम, बाकी डिलीवरी पर",
  ...
  "confirm.cod.advanceNote": "{advance} अग्रिम भुगतान सफलतापूर्वक ऑनलाइन जमा कर दिया गया है। शेष {due} राशि का भुगतान डिलीवरी के समय नकद में लिया जाएगा।",
...
const gu: Dictionary = {
  ...
  "checkout.cod.terms": "સીઓડી બિલ (ડિલિવરી પર રોકડ)",
  "checkout.cod.dueOnDelivery": "ડિલિવરી પર",
  "checkout.cod.advanceNote": "નોંધ: કૅશ ઓન ડિલિવરી ઓર્ડર નક્કી કરવા માટે Cashfree દ્વારા {advance} એડવાન્સ ઓનલાઇન ચૂકવવા જરૂરી છે. બાકીની રકમ ડિલિવરી વખતે ચૂકવવાની રહેશે.",
  "checkout.paymentMethod": "ચુકવણી પદ્ધતિ",
  "checkout.method.online": "ઓનલાઇન ચુકવણી",
  "checkout.method.onlineSub": "કાર્ડ, UPI, નેટબેંકિંગ કે વૉલેટ — Cashfree દ્વારા સુરક્ષિત",
  "checkout.payOnline": "ઓનલાઇન ચુકવણી કરો",
  "checkout.openingPayment": "ચુકવણી ખૂલી રહી છે…",
  "checkout.method.upi": "UPI / GPay",
  "checkout.method.upiSub": "સ્કેન કરો કે ટૅપ કરો — રકમ આપોઆપ ભરાઈ જશે",
  "checkout.method.cod": "કૅશ ઓન ડિલિવરી",
  "checkout.method.codSub": "{advance} એડવાન્સ, બાકી ડિલિવરી વખતે",
  ...
  "confirm.cod.advanceNote": "{advance} એડવાન્સ ચુકવણી સફળતાપૂર્વક ઓનલાઇન થઈ ગઈ છે. બાકી રહેલી {due} રકમ ડિલિવરી વખતે રોકડેથી લેવામાં આવશે.",
