...
const en = {
  ...
  "checkout.cod.advanceNote": "Note: Cash on Delivery orders require a Rs 100 advance paid online via Cashfree to confirm the order. The remaining balance is paid on delivery.",
  ...
  "confirm.cod.advanceNote": "The Rs 100 advance payment was successfully paid online via Cashfree. The remaining balance of {due} will be collected in cash on delivery.",
...
const hi: Dictionary = {
  ...
  "checkout.cod.advanceNote": "ध्यान दें: कैश ऑन डिलीवरी ऑर्डर पक्का करने के लिए Cashfree के ज़रिए 100 रुपये अग्रिम भुगतान ऑनलाइन करना होगा। शेष राशि का भुगतान डिलीवरी के समय लिया जाएगा।",
...
const gu: Dictionary = {
  ...
  "checkout.cod.advanceNote": "નોંધ: કૅશ ઓન ડિલિવરી ઓર્ડર નક્કી કરવા માટે Cashfree દ્વારા 100 રૂપિયા એડવાન્સ ઓનલાઇન ચૂકવવા જરૂરી છે. બાકીની રકમ ડિલિવરી વખતે ચૂકવવાની રહેશે.",
